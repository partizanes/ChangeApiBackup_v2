...
def getAccountsDict():
    try:
      ...
      countAccount = sum(len(cpanelAccountsDict[partition]) for partition in cpanelAccountsDict)
      mainLog.info("[getAccountsDict] Найдено {0} аккаунтов".format(countAccount))
